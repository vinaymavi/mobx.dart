...
/// Computed values are values that can depend on other observables and computed values!
...
class Computed<T> extends Atom implements Derivation {
  ...
  ///
  /// The passed in function: [compute], is used to give back the computed value.
